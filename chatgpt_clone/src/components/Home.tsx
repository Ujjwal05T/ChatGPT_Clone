  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await axios.get(
        `http://localhost:8080/ask?prompt=${input}`
      );
    ...
    <>
      <div className="min-h-screen relative">
        ...
        <div className="min-h-screen relative pb-32">
          <div
            className="custom-scrollbar max-w-3xl mx-auto py-4 space-y-4  h-[calc(100vh-200px)] "
        ...
        <div className="fixed bottom-0 left-0 right-0 lg:p-6 p-3 bg-background/80 backdrop-blur-sm border-t border-secondary">
          <div className="max-w-3xl py-2 px-1 lg:py-3 lg:px-3 rounded-xl mt-2  mx-auto flex items-center space-x-2">
            <Input
              ...
              className="flex-1 py-7 rounded-xl "
            />
            <Button
              disabled={isLoading}
              type="submit"
              ...
              <img
                ...
                style={{
                  filter:
                    "invert(60%) sepia(70%) saturate(500%) hue-rotate(80deg)",
                }}
              />
            </Button>
          </div>
